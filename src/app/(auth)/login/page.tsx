...
<div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
  <div className="grid lg:grid-cols-7 lg:gap-x-8 xl:gap-x-12 lg:items-start">
    <div className="lg:col-span-3">
        ...
        <h1 className="mb-4 text-4xl pt-[5rem]  font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Login</h1>

        </div>
        <div className="">
        <p className="mb-6 text-lg lg:justify-left font-normal text-gray-500 lg:text-lg dark:text-gray-400">Welcome back, login to get your device fixed quick</p>
        ...
        <Input className="my-4 bg-[transparent] rounded-3xl h-12 w-[30rem]" placeholder="Enter Email here"/>
        <Input className="my-4 bg-[transparent] rounded-3xl h-12 w-[30rem]" placeholder="Enter Password here"/>
